    ...
    async getUserByBusinessNumber(businessNumber) {
        try {
            ...
            return {
                ...
                hideReviewTab: userData.hideReviewTab || false,
                hideBanner: userData.hideBanner || false,
                hideTitle: userData.hideTitle || false,
                hideDescription: userData.hideDescription || false,
                reviewTitle: userData.reviewTitle || '',
                reviewDescription: userData.reviewDescription || '',
